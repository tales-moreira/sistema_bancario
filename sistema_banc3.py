...
def recuperar_conta_cli(cliente):
...
def depositar(clientes):
    ...
    conta = recuperar_conta_cli(cliente)
    if not conta:
        return
...
def exibir_extrato(clientes):
    cpf = input("Informe oo cpf do cliente: ")
    cliente = filtrar_cliente(cpf,clientes)
...
def criar_cliente(clientes):
    ...
    cliente = pessoa_fisica(nome=nome, dt_nasc= data_nascimento,cpf=cpf,endereco=endereco)
